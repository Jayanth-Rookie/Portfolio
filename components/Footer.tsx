...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#050505] pt-24 pb-12 overflow-hidden border-t border-white/5 text-white">
      ...
      <div className="container mx-auto px-4 md:px-12 flex flex-col items-center text-center">
        ...
        <button className="group relative px-8 py-4 bg-transparent overflow-hidden rounded-full border border-white/30 hover:border-[#FFCC00] transition-colors duration-300">
